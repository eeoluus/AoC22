# ### PROBLEM DESCRIPTION
#
# A start-of-packet marker is a substring where all characters are 
# different. Given a string, how many characters have 
# to be processed until a marker of length 4 is found?
#
# More info at https://adventofcode.com/2022/day/6.
#

def solution(file):
    """Solve the first problem of Advent of Code 2022 Day 6.
    
    Scan the signal with a moving window of length 4. Converting to set 
